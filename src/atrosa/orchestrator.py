...
def run_detect() -> dict:
    ...
    """
    # Add the project root to PYTHONPATH so detect.py can `import ingest`
    # (detect.py uses bare `import ingest`, not relative imports, because it
